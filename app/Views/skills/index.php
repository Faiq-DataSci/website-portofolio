    ...
    <header>
        <nav class="navbar">
            <ul class="nav-menu">
                ...
                <li><a href="Home#skills" class="active">Skills</a></li>
    ...
    <main class="wrapper container">
        ...
        <section class="skills-hero">
            ...
            <div class="hero-image">
                <img src="/website-portofolio/public/assets/images/skill.png" alt="Skills Illustration" onerror="this.src='https://placehold.co/500x400?text=Skill+Illustration'">
            </div>
        </section>
                ...
                <article class="skill-category">
                    ...
                    <div class="skill-list">
                        <div class="skill-item">
                            ...
                            <div class="progress-bar"><div class="progress blue" style="width: 90%;"></div></div>
                        </div>
                        <div class="skill-item">
                            <div class="skill-info"><span>Pandas</span><span>70%</span></div>
                            <div class="progress-bar"><div class="progress blue" style="width: 70%;"></div></div>
                        </div>
                        <div class="skill-item">
                ...
                <article class="skill-category">
                    ...
                    <div class="skill-list">
                        <div class="skill-item">
                            ...
                            <div class="progress-bar"><div class="progress red" style="width: 50%;"></div></div>
                        </div>
                        <div class="skill-item">
                            <div class="skill-info"><span>TensorFlow</span><span>60%</span></div>
                            <div class="progress-bar"><div class="progress red" style="width: 60%;"></div></div>
                        </div>
                        <div class="skill-item">
                            <div class="skill-info"><span>PyTorch</span><span>70%</span></div>
                            <div class="progress-bar"><div class="progress red" style="width: 70%;"></div></div>
                        </div>
                        <div class="skill-item">
                        ...
                        <div class="skill-item">
                            ...
                            <div class="progress-bar"><div class="progress red" style="width: 40%;"></div></div>
                        </div>
                    </div>
                </article>
                ...
                <article class="skill-category">
                    ...
                    <div class="skill-list">
                        <div class="skill-item">
                            ...
                            <div class="progress-bar"><div class="progress yellow-bar" style="width: 90%;"></div></div>
                        </div>
                        <div class="skill-item">
                            <div class="skill-info"><span>Transformers</span><span>70%</span></div>
                            <div class="progress-bar"><div class="progress yellow-bar" style="width: 70%;"></div></div>
                        </div>
                        <div class="skill-item">
                ...
                <article class="skill-category">
                    ...
                    <div class="skill-list">
                        <div class="skill-item">
                            ...
                            <div class="progress-bar"><div class="progress green-bar" style="width: 90%;"></div></div>
                        </div>
                        <div class="skill-item">
                            <div class="skill-info"><span>CSS</span><span>70%</span></div>
                            <div class="progress-bar"><div class="progress green-bar" style="width: 70%;"></div></div>
                        </div>
                        <div class="skill-item">
